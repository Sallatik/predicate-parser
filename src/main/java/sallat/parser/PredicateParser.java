 ...
 * <h1>Syntax</h1>
 * The input <code>String</code> can contain one or more <i>words</i> and parentheses divided by space character ' '<br>
 ...
 * Case-sensitivity depends on a particular implementation.
